...
from config import (
    RAM_TYPES, SSD_TYPES, BATTERY_TYPES,
    WARRANTY_OPTIONS, WIFI_OPTIONS, BLUETOOTH_OPTIONS,
)
...
def laptop_input_form():
    ...
    with st.form("prediction_form", clear_on_submit=False):
        ...
        st.markdown('<div class="form-eyebrow">Laptop Details</div>', unsafe_allow_html=True)
        ...
        # --- BASICS ---
        st.markdown('<div class="form-eyebrow" style="margin-top:6px;">Basics</div>', unsafe_allow_html=True)
        ...
        # --- MEMORY & STORAGE ---
        st.markdown('<div class="form-eyebrow">Memory &amp; Storage</div>', unsafe_allow_html=True)
        ...
        # --- GRAPHICS & BUILD ---
        st.markdown('<div class="form-eyebrow">Graphics &amp; Build</div>', unsafe_allow_html=True)
        col1, col2, col3 = st.columns(3)
        with col1:
        ...
        # --- POWER & CONNECTIVITY ---
        st.markdown('<div class="form-eyebrow">Power &amp; Connectivity</div>', unsafe_allow_html=True)
        ...
        submitted = st.form_submit_button("Get Price", use_container_width=True, type="primary")
